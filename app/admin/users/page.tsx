                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          className="px-3 py-1.5 text-xs font-medium text-blue-400 hover:text-white bg-blue-500/10 hover:bg-blue-600 border border-blue-500/20 rounded-lg transition-all shadow-sm"
                        >
                          Update
                        </button>
                        <button
                          onClick={() => setDeletingUserId(u.id)}
                          className="px-3 py-1.5 text-xs font-medium text-rose-400 hover:text-white bg-rose-500/10 hover:bg-rose-600 border border-rose-500/20 rounded-lg transition-all shadow-sm"
                        >
                          Delete
                        </button>
                      </div>
