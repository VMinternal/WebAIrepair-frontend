...
export default function TrackingForm({ setActiveTab }: TrackingFormProps) {
  ...
  const handleTrackingSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Demo fallback data matching backend entity structure
      setTrackingResult([
        {
              ...
              <div className="flex justify-between items-center border-b border-slate-800/60 pb-3">
                <div>
                  <h4 className="font-black text-white text-base">
                    {appointmentData.customerName || appointmentData.customer_name}
                  </h4>
                ...
                >
                  ● {isCompleted ? 'Completed' : isInProgress ? 'Under Repair' : 'Awaiting Receipt'}
                </span>
              </div>
